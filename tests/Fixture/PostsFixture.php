...
class PostsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'posts_ibfk_1' => ['type' => 'index', 'columns' => ['category_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'posts_ibfk_1' => ['type' => 'foreign', 'columns' => ['category_id'], 'references' => ['categories', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'published' => 1,
            'created' => '2016-06-01 13:52:28',
            'modified' => '2016-06-01 13:52:28'
        ],
    ];
}
